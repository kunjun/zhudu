...
//     		}
    		...
    		if ($img_type == 'png') {
    			$this->img_display_quality = $this->img_display_quality/10;
    		}
    		
    		ob_start();
    		$func_name($this->h_dst, NULL, $this->img_display_quality);
